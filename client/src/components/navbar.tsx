...
const Navbar = () => {
  ...
  return (
    <>
      {/* Professional Header */}
      <header className="shadow-sm fixed top-0 left-0 right-0 z-50 bg-opacity-100 backdrop-blur-sm transition-colors duration-300">
            ...
            <div className="flex items-center space-x-4 ">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2  rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent bg-background-color border border-[var(--border-primary)]"
                />
              </div>
              <button
                onClick={toggleTheme}
